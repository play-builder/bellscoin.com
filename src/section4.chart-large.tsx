...
export default function EmissionChartLarge() {
	return (
		<div className="relative mx-auto hidden lg:mt-[140px] lg:block lg:w-[1280px]">
			...
			<span className="absolute bottom-[92px] left-[168px] font-mogra text-[24px] tracking-305 text-[#ED2C31]">
				EPOCH1
			</span>
			<span className="absolute bottom-[140px] left-[184px] font-mogra text-[24px] tracking-305 text-[#ED2C31]">
				EPOCH2
			</span>
			<span className="absolute bottom-[300px] left-[248px] font-mogra text-[24px] tracking-305 text-[#ED2C31]">
				EPOCH3
			</span>
			<span className="absolute bottom-[448px] left-[344px] font-mogra text-[24px] tracking-305 text-[#ED2C31]">
				EPOCH4
			</span>
			<span className="absolute bottom-[480px] left-[556px] font-mogra text-[24px] tracking-305 text-[#ED2C31]">
				EPOCH5
			</span>
